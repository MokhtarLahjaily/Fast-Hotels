...
public interface HotelRepository extends JpaRepository<Hotel, Long> {
    ...
    Page<Hotel> findByAmenities(@Param("amenityIds") List<Long> amenityIds, @Param("amenityCount") Long amenityCount, Pageable pageable);
    ...
    @Query(value = "SELECT h.* FROM hotels h WHERE " +
            ...
            "(:maxRating IS NULL OR h.star_rating <= :maxRating)",
