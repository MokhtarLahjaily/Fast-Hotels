...
public interface BookingRepository extends JpaRepository<Booking, Long> {
        ...
        Page<Booking> findByUserAndStatus(@Param("userId") Long userId, @Param("status") BookingStatus status,
                        Pageable pageable);
        ...
        // Find bookings by status with check-in before one date and check-out after
        // another date
        ...
        Page<Booking> findByUserEmailContainingIgnoreCaseAndStatus(String email, BookingStatus status,
                        Pageable pageable);

        Page<Booking> findByUserEmailContainingIgnoreCaseAndCreatedAtAfter(String email, LocalDateTime startDate,
                        Pageable pageable);

        Page<Booking> findByUserEmailContainingIgnoreCaseAndStatusAndCreatedAtAfter(String email, BookingStatus status,
        ...
        // PERFORMANCE WARNING: Leading wildcard LIKE conditions cause full table scans.
        // Consider adding functional indexes or using a full-text search engine.
        @Query("SELECT b FROM Booking b WHERE " +
        ...
        @Query("SELECT b FROM Booking b WHERE " +
                        ...
                        "b.status = :status")
        Page<Booking> findByIdOrUserEmailContainingAndStatus(@Param("search") String search,
        ...
        Page<Booking> findByIdOrUserEmailContainingAndCreatedAtAfter(@Param("search") String search,
        ...
        @Query("SELECT b FROM Booking b WHERE " +
                        ...
                        "b.status = :status AND " +
                        "b.createdAt >= :startDate")
        Page<Booking> findByIdOrUserEmailContainingAndStatusAndCreatedAtAfter(@Param("search") String search,
